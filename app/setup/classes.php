...
<head>
    ...
    <link href="../../lib/orgchart/jquery.orgchart.css?ver=231120211126" rel="stylesheet">
            ...
            <header class="w-100 d-flex flex-column justify-content-between mb-4">
              <div class="card-header">
                ...
                <div class="card-option tx-24">
                  <button class="btn btn-sm btn-primary " data-toggle="modal" data-target="#section_count_modal"><i class="fa fa-plus-circle mr-2 text-white"></i>Add Sections</button>
                
                <?php 
                
                  if(count($inactiveClasses) > 0) { ?>
                  <button class="btn btn-sm btn-primary class_modal_btn" data-toggle="modal" data-target="#class_modal">Add Classes</button>
                  <?php } else  if(count($inactiveClasses) == 0) { ?>
                  <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#class_max_modal">Add Classes</button>
                  <?php } 
            ...
            <div class="row" id="class_modules">
              <div class="accordion w-100 px-6 accordionClass" id="accordionClass">
                ...
                <div class="card mb-3 classAccordon" id="card<?php echo $thisClass['id']; ?>">
                  <div class="card-header d-flex" id="classcch<?php echo $thisClass['id']; ?>">
