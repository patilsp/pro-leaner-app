          ...
          <form class="user_form form-horizontal" action="createUser.php" name="form" method="POST">
            <div class="card-body bd bd-t-0 rounded-bottom">
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group mult">
                      <label class="col-md-12">Department<span class="required_icon" style="color:red;">*</span></label>
                      <select class="form-control" name="dept" id="dept" required>
                          <option value="" selected="selected">Select</option>
                            ...
                            <?php
                                ...
                                {
                                ?>
                                     <option value="<?php echo $rows['id']; ?>"><?php echo $rows['department']; ?></option>
                                <?php
                                    }
                                 ?>
                ...
                <div class="col-md-4">
                  <div class="form-group mult">
                      <label class="col-md-12">Designation<span class="required_icon" style="color:red;">*</span></label>
