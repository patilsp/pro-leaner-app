    ...
    <div class="br-mainpanel">
      ...
      <div class="br-pagebody">
        ...
        <div class="card h-100 d-flex flex-column justify-content-between">
          ...
          <form class="user_form form-horizontal" action="create_role.php" name="form" method="POST">
            <div class="card-body bd rounded-bottom">
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="title">Role:<span class="required_icon" style="color:red;">*</span></label>
            ...
            <div class="card-footer bd bd-t-0 d-flex justify-content-between">
              <a href="roleList.php" class="btn btn-md btn-danger">Cancel</a>
