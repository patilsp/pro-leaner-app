            ...
            <div class="card h-100 d-flex flex-column justify-content-between mb-4">
              <div class="card-header">
                ...
                <div class="card-option tx-24">
                  ...
                  <button class="btn btn-sm btn-flex btn-primary ms-5" data-toggle="modal" data-target="#student_modal" id="add_student_bth">Add User</button>
                </div><!-- card-option -->
              </div><!-- card-header -->
              <div class="card-body">
                  <div class="table-responsive">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><button type="button" class="btn btn-md btn-info btn3d editUser" title="Edit User" data-toggle="modal" data-target="#student_edit_modal" data-id="<?php echo $row['id']; ?>"><i class="fa fa-edit" aria-hidden="true"></i></button></td>
