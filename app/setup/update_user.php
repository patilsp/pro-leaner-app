    ...
    <div class="br-mainpanel">
      ...
      <div class="br-pagebody">
        ...
        <div class="card h-100 d-flex flex-column justify-content-between">
          ...
          <form class="user_form form-horizontal" action="update_user_validation.php" name="form" method="POST">
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="fname" id="fname" value="<?php echo $first_name; ?>" required>
                  </div>
                </div>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="lname" id="lname"  value="<?php echo $last_name; ?>" required>
                  </div>
                </div>
                        ...
                        <select class="form-control" name="role" id="role" required>
                            <option value="" selected="selected">Select</option>
                              ...
                              <?php
                                  ...
                                  {
                                  ?>
                                      <option value="<?php echo $rows['id']; ?>" <?php if($rows['id'] == $roles_id) { ?> selected="selected" <?php } ?>><?php echo $rows['name']?></option>               
                                  <?php
                                      }
                                   ?>
            ...
            <div class="card-footer bd bd-t-0 d-flex justify-content-between">
              <a href="<?php echo $web_root ?>app/setup/userList.php" class="btn btn-md btn-danger">Cancel</a>
