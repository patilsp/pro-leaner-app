      ...
      <div class="" id="main-container">
        ...
        <div class="card qustCard">
          ...
          <div class="card-body">
            ...
            <div class="card mt-4" id="shortAnsTable">
              <div class="card-header">
                <div class="page-breadcrumb d-sm-flex align-items-center">
                  <div class="breadcrumb-title pe-3 border-0"></div>
                  <div class="ms-auto">
                    <button
                      class="btn btn-info shortAnsTable"
                      type="button"
                    >
                      Add Columns
                    </button> 
              ...
              <div class="card-body" id="descTbType">
                <?php
                  $query = "SELECT * FROM qp_shortansertable WHERE qId=?";
                  $stmt = $db->prepare($query);
                ...
                <div class="card-header">
                  <div class="page-breadcrumb d-sm-flex align-items-center">
                    <div class="breadcrumb-title pe-3 border-0">Column <?php echo $i; ?></div>
                    <div class="ms-auto"> <button type="button" data-editorInstance="<?php echo $i; ?>" class="btn btn-danger delete-editor-updateSATB float-end"><i class="fa fa-trash m-0"></i></button> </div>
                  </div>
                </div>
                <textarea name="editorTbQust[<?php echo $i; ?>]" class="editor1" id="editorTbQust<?php echo $i; ?>" rows="10" cols="80"><?php echo htmlspecialchars($row['qustTd']); ?></textarea>
                <textarea class="editor1" name="editorAns[<?php echo $i; ?>]" id="editorAns<?php echo $i; ?>" rows="10" cols="80"><?php echo htmlspecialchars($row['ansTd']); ?></textarea>
              <?php } ?>
              </div>
            </div>
          </div>
