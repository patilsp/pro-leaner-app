                ...
                <div class="row mt-4" id="options-card-body">
                  ...
                  <div class="col-6 position-relative editor mb-5">
                    <div class="page-breadcrumb d-sm-flex align-items-center shadow-lg px-2 py-3">
                      ...
                      <div class="ms-auto">
                        <div class="ms-auto"><button type="button" data-editorInstance="editor<?php echo $i; ?>" class="btn btn-danger delete-editor-update"><i class="fa fa-trash m-0"></i></button></div>
                      </div>
                    </div>
                    <textarea class="ckeditorTxt" id="editor<?php echo $i; ?>"><?php echo htmlspecialchars($row['optionContent']); ?></textarea>
                  </div>
                  <?php } ?>    
                </div>
              </div>
