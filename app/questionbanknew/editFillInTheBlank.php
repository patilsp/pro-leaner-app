      ...
      <div class="" id="main-container">
        ...
        <div class="card qustCard">
          ...
          <div class="card-body">
            ...
            <div class="card mt-4" id="fillInTheBlank">
              <div class="card-header">
                <div class="page-breadcrumb d-sm-flex align-items-center">
                  <div class="breadcrumb-title pe-3 border-0"></div>
                  <div class="ms-auto">
                    <button
                      class="btn btn-info fillInTheBlank"
                      type="button"
                    >
              ...
              <div class="card-body" id="descFillInTheBlankType">
                <?php
                  $query = "SELECT * FROM qp_fillintheblank WHERE qId=?";
                  $stmt = $db->prepare($query);
                ...
                <div class="card-header">
                  <div class="page-breadcrumb d-sm-flex align-items-center">
                    <div class="breadcrumb-title pe-3 border-0">Question</div>
                    <div class="ms-auto"> <button type="button" data-editorInstance="<?php echo $i; ?>" class="btn btn-danger delete-editor-updateFITB float-end"><i class="fa fa-trash m-0"></i></button> </div>
                  </div>
                </div>
                <textarea name="editorFillInTheBlankQust[<?php echo $i; ?>]" class="editor1" id="editorFillInTheBlankQust<?php echo $i; ?>" rows="10" cols="80"><?php echo htmlspecialchars($row['qustFill']); ?></textarea>
              <?php } ?>
              </div>
            </div>
          </div>
