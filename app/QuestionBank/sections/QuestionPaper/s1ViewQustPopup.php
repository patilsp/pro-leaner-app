...
<!-- Modal -->
<div class="modal fade" id="AddviewQustModal" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
    ...
    <div class="modal-content bg-white">
      ...
      <div class="modal-body mt-4">
        ...
        <div class="row justify-content-center" id="displayQuestion">
          ...
          <div class="col-12 mt-3 options qust_option_max_width">
        ...
        <div class="row">
          <div class="col-12">
            <h4 class="font-weight-medium">Details</h4>
            <ul>
              <li>
                <div class="d-flex">
                  <p class="m-0 font-weight-medium">Chapter -</p>
                  <p class="chap_name ml-1"><span id="displayChapterName"></span></p>
                </div>
              </li>
              <li>
                <div class="d-flex">
                  <p class="m-0 font-weight-medium">Question Type - </p>
                  <p class="chap_name ml-1"><span id="displayQuestionType"></span></p>
                </div>
              </li>
              <li>
                <div class="d-flex">
                  <p class="m-0 font-weight-medium">Question Category - </p>
                  <p class="chap_name ml-1"><span id="displayQuestionCategory"></span></p>
                </div>
              </li>
              <li>
                <div class="d-flex">
                  <p class="m-0 font-weight-medium">Difficulty - </p>
                  <p class="chap_name ml-1"><span id="displayDifficulty"></span></p>
                </div>
              </li>
            </ul>
          </div>
