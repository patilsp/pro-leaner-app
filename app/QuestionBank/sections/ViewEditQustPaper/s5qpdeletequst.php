  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-body text-center px-5 py-5">
        ...
        <p class="m-0 font-weight-bold">Are you sure you want to delete the question paper <span class="action_name"></span>? </p>
        <input type="hidden" id="delete_quiz_id" value="">
        <div class="position-relative d-flex justify-content-center mt-5">
          <button class="btn btn-md btn-blue font-weight-medium yes_bth mr-4" id="delete_quiz_yes">Yes</button>
