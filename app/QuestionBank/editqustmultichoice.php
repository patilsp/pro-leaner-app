<?php
  ...
  if(!($questionDetails['qtype'] == "multichoice" && $questionDetails['single'] == 1)) {
    header("location: app/home.php");  
  }
...
<html lang="en">
  ...
  <body class="collapsed-menu">
                    ...
                    <div class="col-12 p-0 h-100">
                      <div class="card">
                        <div class="card-header bg-white border-0">
                          <h5 class="font-weight-bold mb-0">Edit Question</h5>
                        </div>
                            ...
                            <div class="col-12">
                              <div class="form-group mt-3" style="max-width: 400px">
                                ...
                                <select class="form-control qtype" id="qtype" name="qtype">
                                  <option value="multichoice" selected="selected">MCQ with Single Answer </option>
                                </select>
                              </div>
                            </div>

                            <!-- ***************** Start MCQ with Single Answer ******************-->
                            <div class="col-12 multichoice questionDetail" id="mcq_radio_section">
                              <div class="form-group">
                                <label for="qust_txt" class="font-weight-bold">Question</label>
                                <div class="position-relative form-control p-2 QustEditer_blk">
                                  <!-- <div class="QustEditer" id="multichoice_qustediter" contenteditable="true" placeholder="enter text here...">
                                  ...
                                  <textarea class="form-control textarea_custom" id="multichoice_qustediter" name="questiontext" rows="4" cols="50" required="required"><?php echo $questionDetails['QuestionText']; ?></textarea>                      
                                  <hr/>
                                  <hr/>
                                  ...
                                  <header class="w-100 mb-4 d-flex align-items-center">
                                    ...
                                    <button type="button" class="btn btn-md btn-success px-3 border-0 font-weight-medium" id="add_macqRadio_img"><label for="mcopt-img-upload" class="mb-0">Add Image Choice</label></button>
                                  </header>
                                    ...
                                    foreach($questionDetails['Options'] as $key=>$option) {
                                      ...
                                      <div class='col-12 col-sm-6 col-md-6 mb-4 img_opt'>
                                        ...
                                        <div class='form-check d-flex'>
                                          <input class='form-check-input' type='radio' name='mcRadios' value='option2' <?php echo $checked; ?>>
                                          <input type='hidden' name='answer[]' placeholder='Type here' class='mcanswer' value="<?php echo $option['OptionText']; ?>">
                                      ...
                                      <div class='col-12 col-sm-6 col-md-6 mb-4 text_opt'>
                                        ...
                                        <div class='form-check d-flex align-items-center'> 
                                          ...
                                          <label class='form-check-label w-100 pl-1'> 
                                            <input type='text' name='answer[]' placeholder='Type here' value='<?php echo $option['OptionText']; ?>' class='form-control border-0 mcanswer'> 
                                          </label> 
                                          <span class='close_ip'></span>
                                        </div>
                                      </div>
    ...
    <script src="../../js/editqustmcqsa.js"></script>
