...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../../assets/css/QuestionBank/ViewQuestionPaper.css">
    <link rel="stylesheet" href="../../assets/css/QuestionBank/s5qpdeletequst.css">
  </head>
  <body>
    <!-- navbar -->
          ...
          <div class="col-4" id="left_grid">
            <div id="tab_sidebar">
              <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                ...
                <a class="nav-link active" id="v-pills-veqp-tab" data-toggle="pill" href="#v-pills-veqp" role="tab" aria-controls="v-pills-veqp" aria-selected="false">4. View/Edit Question Paper</a>
          ...
          <div class="col-8" id="right_grid">
            <div class="tab-content h-100" id="v-pills-tabContent">
              <div class="tab-pane fade show active h-100" id="v-pills-viewedit" role="tabpanel" aria-labelledby="v-pills-viewedit-tab">
                <?php include("sections/ViewEditQustPaper/s1qpfilters.php"); ?>

                <?php include("sections/ViewEditQustPaper/s2qplist.php"); ?>
              </div>
            </div>
          </div>
        </div>
    ...
    <?php include("sections/ViewEditQustPaper/s5qpdeletequst.php"); ?>
    ...
    <script src="../../assets/js/s2qplist.js"></script>
    <script src="../../assets/js/s1qpfilters.js"></script>
    <script src="../../assets/js/s5qpdeletequst.js"></script>
    ...
    <?php unset($_SESSION['sb_heading']); } 
        if(isset($_SESSION['QP_Cancel_Class'])) {
          ?>
          $("#viewedit_qust_blk").addClass("d-none");
          $("#selectedClass").val("<?php echo $_SESSION['QP_Cancel_Class']; ?>");
          $(".selectclass").trigger("change");
          onloadSubject = "<?php echo $_SESSION['QP_Cancel_Subject']; ?>";
          <?php
          unset($_SESSION['QP_Cancel_Class']);
          unset($_SESSION['QP_Cancel_Subject']);
        }
    ?>
    </script>
  </body>
