<?php
  ...
  if(!($questionDetails['qtype'] == "ddmatch")) {
    header("location: ../home.php");  
  }
...
<html lang="en">
  ...
  <body class="collapsed-menu">
                    ...
                    <div class="card border-0">
                      ...
                      <div class="card-body">
                        ...
                        <div class="row">
                          ...
                          <div class="col-12 ddmatch questionDetail" id="match_section">
                            <div class="form-group">
                              <label class="font-weight-bold">Question Title</label>
                              <textarea class="form-control" id="ddmatch_qustediter" placeholder="Type here" rows="1"><?php echo $questionDetails['QuestionText']; ?></textarea>
                            </div>
                            ...
                            <ol class="row p-0" id="match_header_blk">
                                <li class="col-12 d-flex text-center" id="match_heading">
                                  <input type="text" name="option" placeholder="Type here" value="Question" class="form-control border-0 text-center col-6" disabled="disabled">
                                  <input type="text" name="option" placeholder="Type here" value="Answer" class="form-control border-0 text-center col-6" disabled="disabled">
                                </li>
                              </ol>
                              ...
                              <ol class="row" id="ol_qust_ans">
                                ...
                                <li class="w-100 mb-3 li_qust_ans">
                                  <div class="d-flex position-relative">
                                    ...
                                    <input type="text" name="subquestiontext[]" placeholder="Type here" value="<?php echo $option['subQuestion']; ?>" class="form-control mr-3 subquestiontext">
                                    <input type="text" name="answertext[]" placeholder="Type here" value="<?php echo $option['answerText']; ?>" class="form-control answertext">
    ...
    <script src="../../js/editqustmcqmtf.js"></script>
