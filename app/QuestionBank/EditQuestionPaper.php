<?php
  ...
  $back_page = $web_root."app/QuestionBank/ViewQuestionPaper.php";
  $id = $_GET['id'];
  $quiz_id = Decrypt($id);
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../../assets/css/QuestionBank/EditQuestionPaper.css">
  ...
  <body>
          ...
          <div class="col-4" id="left_grid">
            <div id="tab_sidebar">
              <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                ...
                <a class="nav-link" id="v-pills-cqp-tab" data-toggle="pill" href="QuestionPaper.php#v-pills-cqp" role="tab" aria-controls="v-pills-cqp" aria-selected="false">3. Create Question Paper</a>
                <a class="nav-link active" id="v-pills-veqp-tab" href="#v-pills-veqp" role="tab" aria-controls="v-pills-veqp" aria-selected="false">4. View/Edit Question Paper</a>
            ...
            <div class="tab-content h-100" id="v-pills-tabContent">
              <div class="tab-pane fade show active h-100" id="v-pills-cqp" role="tabpanel" aria-labelledby="v-pills-cqp-tab">
                <div class="row align-items-center justify-content-center h-100 py-4">
                  <?php include("sections/ViewEditQustPaper/s3EditQustFilters.php"); ?>
                  
                  <?php include("sections/ViewEditQustPaper/s3EditSection.php"); ?>
                </div>
              </div>
            </div>
          </div>
    ...
    <script type="text/javascript">
      var selected_chapters = "<?php echo $quizInfo['chapters']; ?>";
      var no_of_attempts = "<?php echo $quizInfo['attempts']; ?>";
      var qp_difficulty = "<?php echo $quizInfo['difficulty']; ?>";
      var quiz_id = "<?php echo $quiz_id; ?>";
      document.getElementById("attempts").value = no_of_attempts;
      // document.getElementById("qpDifficulty").value = qp_difficulty;
    </script>
    <?php include("../common-blocks/js.php"); ?>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.3/js/select2.min.js"></script>
    
    <script src="../../assets/js/QuestionPaperAddEditCommon.js"></script>
    <script src="../../assets/js/EditQuestionPaper.js"></script>
