...
<link rel="stylesheet" type="text/css" href="css/lessons/061vssow09.css">
<!-- Core JS files -->
      ...
      <div class="row mydivs">
        <div class="col-md-12  col-sm-12 col-xs-12 template img-responsive">
          ...
          <div class ="col-md-12 col-sm-12 col-xs-12 _content5"> 
           <div class ="col-md-6 col-sm-16 col-xs-6">          <img src="images/'.$_FILES['img']['name'][0].'" class="img-responsive">
          </div>
          <div class ="col-md-6 col-sm-16 col-xs-6">          <img src="images/'.$_FILES['img']['name'][1].'"  class="img-responsive">
          </div>
