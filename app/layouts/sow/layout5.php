<?php
  ...
  foreach($lp as $key => $value){
    $li = $value;
    if($li != ""){
        $text.='<li> <img id="_objective1" src="harmony7_images/value btn.png"  style="float:left">
...
<title>071vssow15</title>
<link href="../assets/css/bootstrap.css" rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href="css/lessons/071vssow10b.css">
<!-- Core JS files -->
    ...
    <div class="content-wrapper">
      <div class="row mydivs">
        <div class="col-md-12  col-sm-12 col-xs-12 template img-responsive">
          ...
          <div class ="col-md-6 col-sm-6 col-xs-12 _content5"><span class="ans1" style="color:red"><u style="z-index: 1; cursor:pointer;" data-toggle="modal" data-target="#myModal"> <img src="images/'.$_FILES['img']['name'][0].'"  class="img-responsive"> </u></span></div>
          <div class="_content_part4"> 
           <div class="_content4" style="display: block;">
		  ...
		  <div class="modal-dialog modal-sm" role="document">
			<div class="modal-content">
			  ...
			  <div class="modal-body">
				<img class="stranger1_popup center-block img-responsive" src="harmony7_images/pop copy2.png">
			  </div>
