...
<head>
    ...
    <link href="css/lessons/011lsgm03.css" rel="stylesheet" type="text/css" />
</head>
            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12 template img-responsive">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 _content6">
                            <img class="img-responsive" src="images/'.$_FILES['img']['name'][1].'" />
                        </div>
                    </div>
                </div>
            </div>
