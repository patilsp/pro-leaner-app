...
<link href="css/lessons/011lscl05.css" rel="stylesheet" type="text/css" />
</head>
    ...
    <div class="content-wrapper">
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12 template img-responsive">
          ...
          <div class="col-md-6 col-sm-6 col-xs-6 _content5">
            <div class="col-md-12 col-sm-12 col-xs-12"> <img class="img-responsive img_1" src="images/'.$_FILES['img']['name'][0].'" /> </div>
            <div class="col-md-12 col-sm-12 col-xs-12"> <img class="img-responsive img_2" src="images/'.$_FILES['img']['name'][1].'" /> </div>
          </div>
        </div>
      </div>
    </div>
