<?php
  ...
  foreach($lp as $key => $value){
    $li = $value;
    if($li != ""){
        $text.='<li> <img id="_objective1" src="integrity8_images/value btn.png"  style="float:left">
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/lessons/081vssuii11.css">
</head>
                            ...
                            <ul class="_content2">
                                <li>
                                    '.$text.'
                                                      ...
                                                      <br>  <div class="col-md-6 col-sm-6 col-xs-12 _content5">
  ...
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <img class="stranger1_popup center-block img-responsive" src='integrity8_images/pop1.png'>
      </div>
