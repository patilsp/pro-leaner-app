...
<title>071vssuii13</title>
<link href="../assets/css/bootstrap.css" rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href="css/lessons/071vssuii13.css">
<style></style>
</head>
<body>
<!-- Page container -->
    ...
    <div class="content-wrapper">
      <div class="row mydivs">
        <div class="col-md-12  col-sm-12 col-xs-12 template img-responsive">
          ...
          <div class ="col-md-12 col-sm-12 col-xs-12 _content2"> <img src="images/'.$_FILES['img']['name'][0].'" class="img-responsive"> </div>
        </div>
      </div>
    </div>
  </div>
