<?php
  ...
  foreach($lp as $key => $value){
    $li = $value;
    if($li != ""){
        $text.='<li> <img id="_objective1" src="integrity6_images/value btn.png"  style="float:left">
...
<title>061vssuii10</title>
<link href="../assets/css/bootstrap.css" rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href="css/lessons/061vssuii10.css">
<style></style>
</head>
<body>
    ...
    <div class="content-wrapper">
      <div class="row mydivs">
        <div class="col-md-12  col-sm-12 col-xs-12 template img-responsive">
          ...
          <!--<div class ="col-md-6 col-sm-6 col-xs-12 _content6"> <img src="images/'.$_FILES['img']['name'][0].'"  class="img-responsive"> </div>--> 
        </div>
      </div>
    </div>
  </div>
		  ...
		  <div class="modal-dialog modal-sm" role="document">
			<div class="modal-content">
			  ...
			  <div class="modal-body">
				<img class="stranger1_popup center-block img-responsive" src='integrity6_images/3a.png'>
			  </div>
...
<div class="modal fade  bs-example-modal-sm" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog modal-sm" role="document">
			<div class="modal-content">
			  ...
			  <div class="modal-body">
				<img class="stranger1_popup center-block img-responsive" src='integrity6_images/2a.png'>
			  </div>
			  <div class="modal-footer">        
				<button type="button" class="btn btn-primary" data-dismiss="modal">Cancel</button>
			  </div>
...
<div class="modal fade  bs-example-modal-sm" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog modal-sm" role="document">
			<div class="modal-content">
			  ...
			  <div class="modal-body">
				<img class="stranger1_popup center-block img-responsive" src='integrity6_images/1a.png'>
			  </div>
			  <div class="modal-footer">        
				<button type="button" class="btn btn-primary" data-dismiss="modal">Cancel</button>
			  </div>
