...
<html>
    <head>
        ...
        <link href="css/lessons/101vssuii14.css" rel="stylesheet" type="text/css"/>
    </head>
    <body>
        <!-- Page container -->
    ...
    <script>
        $(function() {
                ...
                $("._content2").fadeOut('slow').delay(5000).fadeIn('slow');
                $("._content3").fadeOut('slow').delay(3000).fadeIn('slow');
                $("._content4").fadeOut('slow').delay(4000).fadeIn('slow');
                $("._content5").fadeOut('slow').delay(2000).fadeIn('slow');
