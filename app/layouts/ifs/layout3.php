...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/lessons/061vsifs06.css">
        <style type="text/css">
    ...
    <body> 
                    ...
                    <div class="col-xs-offset-2 col-xs-8">
                            ...
                            <div class="item active">
                                    ...
                                    <div class ="col-md-6 col-sm-6 col-xs-12 _content7">   
                                        <img src="images/'.$_FILES['img']['name'][0].'" class="img-responsive img-res" >
                                    </div>                      
        ...
        <script>
         ...
         $(function(){
                ...
                $("._content7").fadeOut("slow").delay(5000).fadeIn("slow");
