<?php
  ...
  foreach($lp as $key => $value){
    $li = $value;
    if($li != ""){
        $text.='<li> <img id="_objective1" src="work8_images/work btn.png"  style="float:left">
...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="css/lessons/071wemm09b.css">
		<style type="text/css">
			        ...
			        <div class="col-xs-offset-2 col-xs-8">
		                 	...
		                 	<div class="item">
			                        ...
			                        <div class="col-md-12 col-sm-12 col-xs-12">
			                        	<h2 class="_content1">Functions of Money'.$h1[0].'</h2>
