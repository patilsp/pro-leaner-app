<?php
  ...
  foreach($lp as $key => $value){
    $li = $value;
    if($li != ""){
        $text.='<li> <img id="_objective1" src="work7_images/work btn.png"  style="float:left">
...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/lessons/071wemm04.css">
    </head>
    <body>
                            ...
                            <div class="_content1" >
                             ...
                             <!-- <div id="_try" class="pull-right"></div> -->
                                ...
                                <div class ="col-md-6 col-sm-6 col-xs-12 _content5">
                                    <span class="ans1" style="color:red"><u style="z-index: 1; cursor:pointer;" data-toggle="modal" data-target="#showToolTip"> <img  src="work7_images/6.png" align="middle" style="float:left" >  </u> </span>      
        ...
        <!-- Modal -->
        <div class="modal fade  bs-example-modal" id="showToolTip" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-body">
                <img class="stranger1_popup center-block img-responsive" src='work7_images/21a.png'>
              </div>
            </div>
...
<script>
    $(function(){
        ...
        $("._content5").fadeOut("slow").delay(8000).fadeIn("slow");
