<?php
  ...
  foreach($lp as $key => $value){
    $li = $value;
    if($li != ""){
        $text.='<li> <img id="_objective1" src="scientific7_images/natural btn.png"  style="float:left">
...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="css/lessons/072vsstst09.css">
		<style type="text/css">
			        ...
			        <div class="col-xs-offset-2 col-xs-8">
			                ...
			                <div class="item active">
									...
									<div class ="col-md-12 col-sm-12 col-xs-12 _content3">	 
										<img src="images/'.$_FILES['img']['name'][0].'" align="middle" class="img_center_2 center-block img-responsive" >
									</div>
									<div class="col-md-12 col-sm-12 col-xs-12">
			                        	<div class="content_part">
											<ul class="_content4">
											   <li>
													<img id="_objective1" src="scientific7_images/natural btn.png"  style="float:left"> 
													<p style="margin-left:30px;">
														You are in a forest and are very thirsty. You have finished all your water.
													</p>
												</li>
											</ul> 
										</div>				
