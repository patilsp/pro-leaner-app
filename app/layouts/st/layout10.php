<?php
  ...
  foreach($lp as $key => $value){
    $li = $value;
    if($li != ""){
        $text.='<li> <img id="_objective1" src="logical6_images/natural btn.png"  style="float:left">
...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/lessons/062vsst28.css">
    </head>
    <body>
                        ...
                        <div class="col-md-12  col-sm-12 col-xs-12 template img-responsive"> 
                            <div class="_content1" >
                             ...
                             <!-- <div id="_try" class="pull-right"></div> -->
                                ...
                                <div class ="col-md-6 col-sm-6 col-xs-12 _content7">
                                    <u style="z-index: 1; cursor:pointer;" data-toggle="modal" data-target="#showToolTip">
                                        <img class="ans img-responsive"  src="logical6_images/8.png" align="middle" style="float:left" >      
                                    </u> 
                                </div>                              
                        </div>
                    </div>
          ...
          <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
              <div class="modal-body">
                <img class="stranger1_popup center-block img-responsive" src="logical6_images/8ans.png">
              </div>
            </div>
