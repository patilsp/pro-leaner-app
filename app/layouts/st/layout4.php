<?php
  ...
  foreach($lp as $key => $value){
    $li = $value;
    if($li != ""){
        $text.='<li> <img id="_objective1" src="scientific6_images/natural btn.png"  style="float:left">
...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="css/lessons/062vsst08a.css">
		 <style type="text/css">
			        ...
			        <div class="col-xs-offset-2 col-xs-8">
			                ...
			                <div class="item">
			                        ...
			                        <div class="col-md-12 col-sm-12 col-xs-12 _content5">
		                        		...
		                        		<span class="ans1" style="color:red"><u style="z-index: 1; cursor:pointer;" data-toggle="modal" data-target="#myModal"><img src="images/'.$_FILES['img']['name'][0].'"  class="img_center_1 img-responsive"></u></span>
	                        				
	                        		</div>
			                        <div class ="col-md-12 col-sm-12 col-xs-12 _content_part6 _content5">	 
										<p>'.$text.'</p>
									</div>			
	      ...
	      <div class="modal-dialog modal-sm" role="document">
	        <div class="modal-content">
	          ...
	          <div class="modal-body">
	            <img class="stranger1_popup center-block img-responsive" src="scientific6_images/susperstition.png">
	          </div>
