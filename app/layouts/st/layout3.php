<?php
  ...
  foreach($lp as $key => $value){
    $li = $value;
    if($li != ""){
        $text.='<li> <img id="_objective1" src="scientific6_images/value btn.png"  style="float:left">
...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="css/lessons/062vsst04a.css">
		 <style type="text/css">
			    ...
			    <div class="row template">
			        <div class="col-xs-offset-2 col-xs-8">
			                ...
			                <div class="item">
			                        ...
			                        <div class="col-md-12 col-sm-12 col-xs-12 _content2">
			                        	<!-- start list1 -->
			                        	<div class="col-md-3 col-sm-3 col-xs-3">
