...
<title>061vscoi04</title>
<link href="../assets/css/bootstrap.css" rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href="css/lessons/061vscoi04.css">
<!-- Core JS files -->
    ...
    <div class="content-wrapper">
      <div class="row mydivs">
        <div class="col-md-12  col-sm-12 col-xs-12 template img-responsive">
         ...
         <!-- <div class ="col-md-6 col-sm-12 col-xs-12 _content6"> <img src="mycountry3_images/9.png"  class="img-responsive"> </div>-->
        </div>
      </div>
    </div>
  </div>
