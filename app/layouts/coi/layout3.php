...
<title>061vscoi08</title>
<link href="../assets/css/bootstrap.css" rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href="css/lessons/061vscoi08.css">
<!-- Core JS files -->
    ...
    <div class="content-wrapper">
      <div class="row mydivs">
        <div class="col-md-12  col-sm-12 col-xs-12 template img-responsive">
          ...
          <div class ="col-md-6 col-sm-12 col-xs-12 content_part">
          ...
          <div class ="col-md-6 col-sm-12 col-xs-12 _content7"> <img src="'.$img[0].'"  class="img-responsive"> </div>
        </div>
        
        <div class ="col-md-12 col-sm-12 col-xs-12 content_part2">
            <div class ="col-md-6 col-sm-12 col-xs-12 _content6 "><p style="color:#0000ff"><b> Click on the underlined word to know more...</b></p></div>
          </div>
      </div>
    </div>
  </div>
...
<div class="modal fade  bs-example-modal-sm" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body"> <img class="stranger1_popup center-block img-responsive" src="constitution6_images/1cc.png"> </div>
