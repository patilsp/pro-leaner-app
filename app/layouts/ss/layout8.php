...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="css/lessons/061lsss13.css">
	</head>
    <body>
				...
				<div class="content-wrapper">
					<div class="row">
						<div class="col-md-12  col-sm-12 col-xs-12 template img-responsive"> 
                            ...
                            <div class ="col-md-12 col-sm-12 col-xs-12 _content2">
                            	<center>
		                 			<div class ="col-md-6 col-sm-6 col-xs-6">
										<img src="images/'.$_FILES['img']['name'][0].'" data-toggle="modal" class="img-responsive" data-target="#myModal"style="z-index: 1; cursor:pointer;">
									</div>
				                    <div class ="col-md-6 col-sm-6 col-xs-6">	 
						    ...
						    <div class ="col-md-12 col-sm-12 col-xs-12 _content3 content_part"> 
						    	<center>
		  ...
		  <div class="modal-dialog modal-sm" role="document">
			<div class="modal-content">
			  ...
			  <div class="modal-body">
				<img class="stranger1_popup center-block img-responsive" src="social6_images/3.png">
			  </div>
