...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="css/lessons/101lsss12b.css">
		<style type="text/css">
			    ...
			    <div class="row template">
			        <div class="col-xs-offset-2 col-xs-8">
							...
							<div class="item">
			                        ...
			                        <div class="col-md-12 col-sm-12 col-xs-12 content_part4">
			                        	<div class="_content1">
			                        		<h2>'.$h1[0].'</h2>
			                        	</div>
			                        	<!-- start list1 -->
										...
										<div class="col-md-12 col-sm-12 col-xs-12 _content4">
					                        <img src="images/'.$_FILES['img']['name'][0].'" class="img_center_1 center-block img-responsive">
					                        <p><br></p>
				                        </div>
				                    </div>
			                        ...
			                        <div class="col-md-12 col-sm-12 col-xs-12 content_part4">
										...
										<div class="col-md-12 col-sm-12 col-xs-12 _content6">
			                        		<img src="images/'.$_FILES['img']['name'][1].'" class="img_center_1 center-block img-responsive">
			                        		<p><br></p>
		                        		</div>
									</div>
