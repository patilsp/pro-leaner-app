<?php
  ...
  foreach($lp as $key => $value){
    $li = $value;
    if($li != ""){
        $text.='<li> <img id="_objective1" src="social9_images/social6btn.png"  style="float:left">
...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="css/lessons/091lsss12a.css">
		<style type="text/css">
			        ...
			        <div class="col-xs-offset-2 col-xs-8">
			                ...
			                <div class="item">
			                        ...
			                        <div class="col-md-12 col-sm-12 col-xs-12 content_part2">
			                        	...
			                        	<h2 class="_content1">'.$h1[0].'</h2>
			                        	<div class="col-md-5 col-sm-5 col-xs-12">
			                        		<center class="_content2">
					                        	<img class="img-responsive img_center_2" src="images/'.$_FILES['img']['name'][0].'">
					                        	<br />
					                        </center>
				                        </div>
				                    ...
				                    <div class="col-md-12 col-sm-12 col-xs-12">
				                        ...
				                        <div class="col-md-5 col-sm-5 col-xs-12">
				                        	<center class="_content3">
				                        		<img class="img-responsive img_center_2" src="images/'.$_FILES['img']['name'][1].'">
				                        		<br />
				                        	</center>
				                        </div>
