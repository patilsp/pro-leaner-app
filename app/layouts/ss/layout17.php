...
<link rel="stylesheet" type="text/css" href="css/lessons/072lsss18.css">
<!-- Core JS files -->
...
<script>
	   $(function(){
		...
		// $("._content1").jQueryTween({ to: { translate: { x: 70, y: 90 } },delay	: 0, yoyo: false ,easing: TWEEN.Easing.Cubic.Out});
		 $("._content1").fadeOut("slow").delay(1000).fadeIn("slow");
		// $("._content2").jQueryTween({ to: { translate: { x: 70, y: 90 } },delay	: 1000, yoyo: false });
		 $("._content3").fadeOut("slow").delay(2000).fadeIn("slow");
		// $("._content3").jQueryTween({ to: { translate: { x: 70, y: 90 } },delay	: 2000, yoyo: false });
		 $("._content4").fadeOut("slow").delay(3000).fadeIn("slow");
		 $("._content5").fadeOut("slow").delay(4000).fadeIn("slow");
		 $("._content6").fadeOut("slow").delay(5000).fadeIn("slow");
		 $("._content7").fadeOut("slow").delay(6000).fadeIn("slow");
		 $("._content8").fadeOut("slow").delay(7000).fadeIn("slow");
		 $("._content9").fadeOut("slow").delay(8000).fadeIn("slow");
		 //$(".sticky_img").jQueryTween({ to: { rotate: { x: 0, y: -360, z: -360 } }, yoyo: true }).delay(1000);
		$(".sticky_img").fadeOut("slow").delay(500).fadeIn("slow");
		});
</script>
<style></style>
</head>
    ...
    <div class="content-wrapper">
      <div class="row mydivs">
        <div class="col-md-12  col-sm-12 col-xs-12 template img-responsive">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12 image_part">
          <div class ="col-md-3 col-sm-3 col-xs-3 _content3"> 
            <img src="images/'.$_FILES['img']['name'][0].'"  class="img-responsive"> 
            <h2 class="img_title_1">'.$h1[0].' </h2> 
          </div>
          <div class ="col-md-3 col-sm-3 col-xs-3 _content4"> 
            <img src="images/'.$_FILES['img']['name'][1].'"  class="img-responsive"> 
            <h2 class="img_title_2">'.$h1[0].' </h2>
          </div>
          <div class ="col-md-3 col-sm-3 col-xs-3 _content5"> 
            <img src="images/'.$_FILES['img']['name'][2].'" class="img-responsive"> 
            <h2 class="img_title_3">'.$h1[0].' </h2>
          </div>
          <div class ="col-md-3 col-sm-3 col-xs-3 _content6"> 
            <img src="images/'.$_FILES['img']['name'][3].'" class="img-responsive"> 
            <h2 class="img_title_4">'.$h1[0].' </h2>
          </div>
        </div>
        </div>
      </div>
