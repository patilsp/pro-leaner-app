...
<link rel="stylesheet" type="text/css" href="css/lessons/081lsss06.css">
</head>
<body>
    ...
    <div class="content-wrapper">
      <div class="row">
        <div class="col-md-12  col-sm-12 col-xs-12 template img-responsive">
          ...
          <div class ="col-md-6 col-sm-6 col-xs-12 _content2">
          <span class="ans1" style="color:red"><u style="z-index: 1; cursor:pointer;" data-toggle="modal" data-target="#myModal">  <img src="social8_images/8a.png" class="img-responsive sticky_img"></u></span></div>
          <div class="col-md-6 col-sm-6 col-xs-12 _content2 pull-right"> <span class="ans1" style="color:red"><u style="z-index: 1; cursor:pointer;" data-toggle="modal" data-target="#myModal1"> <img src="images/'.$_FILES['img']['name'][0].'"  class="img-responsive sticky_img1"></u></span> </div>
          <div class="col-md-12 col-xs-12 col-sm-12 _content_part3">
            <center class="_content3">
              <b>'.$text.'</b>
            </center>
          </div>
        </div>
		  ...
		  <div class="modal-dialog modal-sm" role="document">
			<div class="modal-content">
			  ...
			  <div class="modal-body">
				<img class="stranger1_popup center-block img-responsive" src="social8_images/4.png">
			  </div>
		...
		<div class="modal fade  bs-example-modal-sm" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog modal-sm" role="document">
			<div class="modal-content">
			  ...
			  <div class="modal-body">
				<img class="stranger1_popup center-block img-responsive" src="social8_images/3.png">
			  </div>
			  <div class="modal-footer">        
				<button type="button" class="btn btn-primary" data-dismiss="modal">Cancel</button>
			  </div>
