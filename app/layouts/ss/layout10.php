<?php
  ...
  foreach($lp as $key => $value){
    $li = $value;
    if($li != ""){
        $text.='<li> <img id="_objective1" src="social7_images/social6btn.png"  style="float:left">
...
<link rel="stylesheet" type="text/css" href="css/lessons/071lsss09a.css">
</head>
      ...
      <div class="col-xs-offset-1 col-xs-10">
          ...
          <div class="item">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <h2 class="_content1">'.$h1[0].' <span style="font-size: 16px">- Non verbal communication - Gestures</span></h2>
                  <div class="col-md-9 col-sm-9 col-xs-9">
                    <ul class="_content2">
                      '.$text.'
                    </ul>
                  </div>
                  <div class="col-md-3 col-sm-3 col-xs-3 _content2"> <img class="pull-left img_left_2 img-responsive" src="images/'.$_FILES['img']['name'][0].'"> </div>
                </div>
                <!-- 2 list -->
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="col-md-9 col-sm-9 col-xs-9">
                    <ul class="_content3">
                      <li> <img id="_objective1" src="social7_images/social6btn.png"  style="float:left">
                        <p style="margin-left:49px;"> People keep their fingers crossed as a sign of "wishing for good luck or fortune" or "hoping". To make the sign, the index finger is crossed with the middle finger. </p>
                      </li>
                    </ul>
                  </div>
                  <div class="col-md-3 col-sm-3 col-xs-3 _content3"> <img class="pull-left img_left_2 img-responsive" src="social7_images/10d.png"> </div>
                </div>
                <!-- end 2 list --> 
              </div>
