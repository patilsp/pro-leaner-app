<?php
  ...
  foreach($lp as $key => $value){
    $li = $value;
    if($li != ""){
        $text.='<li> <img id="_objective1" src="social9_images/social skills btn.png"  style="float:left">
...
<link rel="stylesheet" type="text/css" href="css/lessons/092lsss13.css">
</head>
<body>
  ...
  <div class="page-content"> 
    ...
    <div class="content-wrapper">
      <div class="row">
        ...
        <div class ="col-md-10 col-sm-10 col-xs-12 _content5"> <img src="images/'.$_FILES['img']['name'][0].'"  class="img-responsive"> </div>
      </div>
        </div>
      </div>
    </div>
