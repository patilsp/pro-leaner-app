...
<html>
	<head>
		...
		<title>PREPMYSKILLS - 061lsss14</title>

		<link href="../assets/css/bootstrap.css" rel="stylesheet" type="text/css">
		<link rel="stylesheet" type="text/css" href="css/lessons/061lsss14.css">
	</head>
    <body>
				...
				<div class="content-wrapper">
					<div class="row">
						<div class="col-md-12  col-sm-12 col-xs-12 template img-responsive"> 
                            <div class ="col-md-8 col-md-offset-2 col-sm-12 col-xs-12 _content1">
	                 			 <img src="images/'.$_FILES['img']['name'][0].'"  class="content_bg_img img-responsive">
						    </div>
