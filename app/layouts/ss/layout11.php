...
<link rel="stylesheet" type="text/css" href="css/lessons/071lsss12.css">
<!-- Core JS files -->
      ...
      <div class="row mydivs">
        <div class="col-md-12  col-sm-12 col-xs-12 template img-responsive">
          ...
          <div class ="col-md-6 col-sm-6 col-xs-12 _content6">
            <div class="col-md-12 col-sm-12 col-xs-12"> <img src="images/'.$_FILES['img']['name'][0].'"  class="img-responsive sticky_img"></div>
            <div class="col-md-12 col-sm-12 col-xs-12"> <img src="images/'.$_FILES['img']['name'][1].'"  class="img-responsive sticky_img1"></div>
            <div class="col-md-12 col-sm-12 col-xs-12"> <img src="images/'.$_FILES['img']['name'][2].'"  class="img-responsive sticky_img2"></div>
          </div>
        </div>
      </div>
    </div>
