...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="css/lessons/061lsss12a.css">
	</head>
	<style type="text/css">
			        ...
			        <div class="col-xs-offset-2 col-xs-8">
			                ...
			                <div class="item">
			                        	...
			                        	<h2 class="_content1">'.$h1[0].' </h2>
		                        			...
		                        			<div class="col-md-4 col-sm-4 col-xs-4 _content2">
		                        				<img id="_objective1" class="img-responsive" src="images/'.$_FILES['img']['name'][0].'">
		                        			</div>
		                        			<div class="col-md-4 col-sm-4 col-xs-4 _content2">
		                        				<img id="_objective1" class="img-responsive" src="images/'.$_FILES['img']['name'][1].'">
		                        			</div>
		                        			<div class="col-md-4 col-sm-4 col-xs-4 _content2">
		                        				<img id="_objective1" class="img-responsive" src="images/'.$_FILES['img']['name'][2].'">
		                        			</div>
