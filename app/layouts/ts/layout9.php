...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="css/lessons/062lsts07c.css">
		<style type="text/css">
			    ...
			    <div class="row template">
			        <div class="col-xs-offset-2 col-xs-8">
							...
							<div class="item">
			                        	...
			                        	<h2 class="_content1">Creative thinking - Invention of wheel</h2>
			                        	<div class="desc _content2">
			                        		<h3>'.$h1[0].'</h3>
			                        	</div>
