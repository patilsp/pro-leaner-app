...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/lessons/092lsts18.css">
</head>
    ...
    <div class="container-fluid">
        ...
        <div class="page-content">
            ...
            <div class="content-wrapper">
                <div class="row"> </div>
                <div class="row">
                    <div class="col-md-12  col-sm-12 col-xs-12 template img-responsive govar">

                            <ul class="list-group group-control govar">
                               '.$text.'
                            </ul>

                            <ul class="list-group group-control">
                                '.$text.'
                            </ul>
