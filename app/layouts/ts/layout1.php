...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="css/lessons/061lsts06.css">
		<style type="text/css">
			    ...
			    <div class="row template">
			        <div class="col-xs-offset-2 col-xs-8">
			                ...
			                <div class="item active">
									...
									<div class =" _content3">	 
										<img src="images/'.$_FILES['img']['name'][0].'" align="middle" class="img_center_1 center-block img-responsive" >
									</div>					
