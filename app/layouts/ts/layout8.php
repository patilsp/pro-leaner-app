<?php
  ...
  foreach($lp as $key => $value){
    $li = $value;
    if($li != ""){
        $text.='<li> <img id="_objective1" src="thinking6_images/thinking skill btn.png"  style="float:left">
...
<link rel="stylesheet" type="text/css" href="css/lessons/062lsts14.css">
</head>
<body>
    ...
    <div class="content-wrapper">
      <div class="row">
        <div class="col-md-12  col-sm-12 col-xs-12 template img-responsive">
          ...
          <div class ="col-md-6 col-sm-6 col-xs-12 _content_part2">
            <ul class="_content2">
              < '.$text.'
            </ul>
            
          </div>
          <div class="col-md-6 col-sm-6 col-xs-12 _content7 pull-right">
            <div class="col-md-12 col-sm-12 col-xs-12"><span class="ans1" style="color:red"><u style="z-index: 1; cursor:pointer;" data-toggle="modal" data-target="#myModal"> <img src="thinking6_images/22A.png" class="img-responsive sticky_img"></u></span> </div>
            <div class="col-md-12 col-sm-12 col-xs-12"><span class="ans1" style="color:red"><u style="z-index: 1; cursor:pointer;" data-toggle="modal" data-target="#myModal1"> <img src="thinking6_images/22B.png" class="img-responsive sticky_img1"></u></span> </div>
            
          </div>
          <div class="col-md-12 col-xs-12 col-sm-12 _content_part3">
            <center class="_content8">
              <b> '.$text.'</b>
            </center>
          </div>
        </div>
  ...
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body"> 
        <center>
          <h2>Critical thinkers</h2>
          <br/>
          <p>Whereas in the story of "Hare and the tortoise", the tortoise was very clear that despite being slow it could win the race.</p>
        </center>
      </div>
...
<div class="modal fade  bs-example-modal-sm" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body"> <img class="stranger1_popup center-block img-responsive" src="thinking6_images/3aa.png"> </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
      </div>
    </div>
