...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="css/lessons/061lsts06b.css">
		<style type="text/css">
			        ...
			        <div class="col-xs-offset-2 col-xs-8">
			                ...
			                <div class="item">
									...
									<div class ="col-md-12 col-sm-12 col-xs-12 _content2">	 
											<img src="images/'.$_FILES['img']['name'][0].'" align="middle" class="img_center_3 center-block img-responsive" >
										</div>
			                        </div>
