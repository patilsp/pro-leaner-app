<?php
  ...
  foreach($lp as $key => $value){
    $li = $value;
    if($li != ""){
        $text.='<li> <img id="_objective1" src="thinking7_images/thinking btn.png"  style="float:left">
...
<link rel="stylesheet" type="text/css" href="css/lessons/072lsts16.css">
      ...
      <div class="row mydivs">
        <div class="col-md-12  col-sm-12 col-xs-12 template img-responsive">
          ...
          <div class ="col-md-12 col-sm-12 col-xs-12 content_part"> 
			    <div class="col-md-6 col-sm-6 col-xs-6  content_part_li">	 
						<ul class="_content2">
							         '.$text.'
							    </ul>
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-6 content_part_li_1">   
                                <ul class="_content3" style="float:left;">
							         '.$text.'
							    </ul> 
                                </div>  
                                </div>
								...
								<h2 class="img_title_1">'.$text.' </h2>
								<h2 class="img_title_2">'.$text.' </h2>
						    </div>
