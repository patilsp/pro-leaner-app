...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/lessons/102vsich16.css">
        <style type="text/css">
                ...
                <div class="row template">
                    <div class=" col-xs-12">
                             ...
                             <div class="item">
                                    ...
                                    <div class ="col-md-6 col-sm-6 col-xs-12 _content1">  
                                       <img class="_content5e" src="images/'.$_FILES['img']['name'][0].'"   class="center-block img-responsive" >
                                    </div>  
