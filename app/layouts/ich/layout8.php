<?php
  ...
  foreach($lp as $key => $value){
    $li = $value;
    if($li != ""){
        $text.='<li> <img id="_objective1" src="value9_images/value btn.png"  style="float:left">
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/lessons/092vsich14a.css">
</head>
                    ...
                    <div class="col-md-12  col-sm-12 col-xs-12 template img-responsive">
                        <div class="_content1">
                         ...
                         <div class="_content2">
                           <ul class="_content2">
                                <li>
                                    <img id="_objective1" src="value9_images/value btn.png" style="float:left">
                                    <p style="margin-left:30px;">The 22 official languages as recognized by Indian constitution are:</p>
                                </li>
                            </ul>
                        </div>
