<?php
  ...
  foreach($lp as $key => $value){
    $li = $value;
    if($li != ""){
        $text.='<li> <img id="_objective1" src="constitution6_images/value btn.png"  style="float:left">
...
<html>
    <head>
        ...
        <link href="css/lessons/102vsich10.css" rel="stylesheet" type="text/css"/>
    ...
    <body>
                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12 template img-responsive">
                            ...
                            <div class ="col-md-12 col-sm-12 col-xs-12 _content2 content_part">  
                                <div class ="col-md-2 col-sm-2 col-xs-2">
                                    <span class="ans1" style="color:red"><u style="z-index: 1; cursor:pointer;" data-toggle="modal" data-target="#myModal1"><img src="images/'.$_FILES['img']['name'][0].'" align="middle" class="center-block img-responsive" ></u></span>
                                </div>
                                <div class ="col-md-2 col-sm-2 col-xs-2">
                                    <span class="ans1" style="color:red"><u style="z-index: 1; cursor:pointer;" data-toggle="modal" data-target="#myModal2"><img src="images/'.$_FILES['img']['name'][1].'" align="middle" class="center-block img-responsive" ></u></span>
                                </div>
                                <div class ="col-md-2 col-sm-2 col-xs-2">
                                    <span class="ans1" style="color:red"><u style="z-index: 1; cursor:pointer;" data-toggle="modal" data-target="#myModal3"><img src="images/'.$_FILES['img']['name'][2].'" align="middle" class="center-block img-responsive" ></u></span>
                                </div>
                                <div class ="col-md-2 col-sm-2 col-xs-2">
                                    <span class="ans1" style="color:red"><u style="z-index: 1; cursor:pointer;" data-toggle="modal" data-target="#myModal4"><img src="images/'.$_FILES['img']['name'][3].'" align="middle" class="center-block img-responsive" ></u></span>
                                </div>
                                <div class ="col-md-2 col-sm-2 col-xs-2">
                                    <span class="ans1" style="color:red"><u style="z-index: 1; cursor:pointer;" data-toggle="modal" data-target="#myModal5"><img src="images/'.$_FILES['img']['name'][4].'" align="middle" class="center-block img-responsive" ></u></span>
                                </div>
                                <div class ="col-md-2 col-sm-2 col-xs-2">
                                    <span class="ans1" style="color:red"><u style="z-index: 1; cursor:pointer;" data-toggle="modal" data-target="#myModal6"><img src="images/'.$_FILES['img']['name'][5].'" align="middle" class="center-block img-responsive" ></u></span>
                                </div>
                                <p><br /></p>
                            </div> 
                            <div class ="col-md-12 col-sm-12 col-xs-12 _content_part6 _content3">    
          ...
          <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <img class="stranger1_popup center-block img-responsive" src="value10_images/10aa.png">
              </div>
        ...
        <div class="modal fade  bs-example-modal-sm" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <img class="stranger1_popup center-block img-responsive" src="value10_images/10bb.png">
              </div>
              <div class="modal-footer">        
                <button type="button" class="btn btn-primary" data-dismiss="modal">Cancel</button>
              </div>
        ...
        <div class="modal fade  bs-example-modal-sm" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <img class="stranger1_popup center-block img-responsive" src="value10_images/10cc.png">
              </div>
              <div class="modal-footer">        
                <button type="button" class="btn btn-primary" data-dismiss="modal">Cancel</button>
              </div>
        ...
        <div class="modal fade  bs-example-modal-sm" id="myModal4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <img class="stranger1_popup center-block img-responsive" src="value10_images/10dd.png">
              </div>
              <div class="modal-footer">        
                <button type="button" class="btn btn-primary" data-dismiss="modal">Cancel</button>
              </div>
        ...
        <!-- Modal -->
        <div class="modal fade  bs-example-modal-sm" id="myModal5" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              ...
              <div class="modal-body">
                <img class="stranger1_popup center-block img-responsive" src="value10_images/10ee.png">
              </div>
              <div class="modal-footer">        
                <button type="button" class="btn btn-primary" data-dismiss="modal">Cancel</button>
              </div>
        ...
        <!-- Modal -->
        <div class="modal fade  bs-example-modal-sm" id="myModal6" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              ...
              <div class="modal-body">
                <img class="stranger1_popup center-block img-responsive" src="value10_images/10ff.png">
              </div>
              <div class="modal-footer">        
                <button type="button" class="btn btn-primary" data-dismiss="modal">Cancel</button>
              </div>
