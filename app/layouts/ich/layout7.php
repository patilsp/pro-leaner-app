<?php
  ...
  foreach($lp as $key => $value){
    $li = $value;
    if($li != ""){
        $text.='<li> <img id="_objective1" src="value8_images/value btn.png"  style="float:left">
...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/lessons/082vsich07.css">
        <style type="text/css">
                ...
                <div class="row template">
                    <div class="col-xs-offset-2 col-xs-8">
                            ...
                            <div class="item active">
                                        ...
                                        <center>
                                            <img src="images/'.$_FILES['img']['name'][0].'"  class="img-responsive _content4">
                                        </center>
		  ...
		  <div class="modal-dialog modal-sm" role="document">
			<div class="modal-content">
			  <div class="modal-body">
				<img class="center-block img-responsive" src="value8_images/Burial chamber.png">
			  </div>
			</div>
