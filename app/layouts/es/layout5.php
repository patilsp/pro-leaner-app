...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="css/lessons/062lses05.css">
	</head>
			    ...
			    <div class="row template">
			        <div class="col-xs-offset-2 col-xs-8">
			                ...
			                <div class="item active">
			                        ...
			                        <div class="col-md-12 col-sm-12 col-xs-12 _content1">
			                        	<h2>'.$h1[0].'</h2>
                                       
			                        	<!-- start list1 -->
			                        	<div class="col-md-3 col-sm-3 col-xs-3 _content2">
			                        		<img class="pull-right img_left_1 img-responsive" src="images/'.$_FILES['img']['name'][0].'" >
			                        	</div>
			                        	<div class="col-md-9 col-sm-9 col-xs-9 _content2">
			                        		'.$text.'
			                        	</div>
									   	<!-- end list2 --> 	 							
			                        </div>
			                        <div class="col-md-12 col-sm-12 col-xs-12 _content3">
			                        	<!-- start list1 -->
			                        	<div class="col-md-3 col-sm-3 col-xs-3">
			                        		<img class="pull-right img_left_2 img-responsive" src="images/'.$_FILES['img']['name'][1].'" >
			                        	</div>
			                        ...
			                        <div class="col-md-12 col-sm-12 col-xs-12 _content4">
			                        	<!-- start list1 -->
			                        	<div class="col-md-3 col-sm-3 col-xs-3">
			                        		<img class="pull-right img_left_3 img-responsive" src="images/'.$_FILES['img']['name'][2].'" >
			                        	</div>
			                        	<div class="col-md-9 col-sm-9 col-xs-9">
			                        		'.$text.'
			                        	</div>
			                        ...
			                        <div class="col-md-12 col-sm-12 col-xs-12 _content5">
			                        	<!-- start list1 -->
			                        	<div class="col-md-3 col-sm-3 col-xs-3">
			                        		<img class="pull-right img_left_4 img-responsive" src="images/'.$_FILES['img']['name'][3].'" >
			                        	</div>
			                        	<div class="col-md-9 col-sm-9 col-xs-9">
			                        		'.$text.'
			                        	</div>
