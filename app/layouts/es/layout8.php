...
<link rel="stylesheet" type="text/css" href="css/lessons/081lses14.css">
</head>
    ...
    <div class="content-wrapper">
      <div class="row">
        <div class="col-md-12  col-sm-12 col-xs-12 template img-responsive">
          <div class="col-md-12 col-sm-12 col-xs-12 table-responsive content_part">
            ...
            <table class="table table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <th scope="row"> <span class="ans" style="color:red; cursor:pointer" data-toggle="modal"  data-target="#showToolTip">'.$h1[0].'</span></th>
                  <td>'.$text.'</td>
                </tr>
                <tr>
                  <th scope="row">'.$h1[0].'</th>
...
<div class="modal fade  bs-example-modal" id="showToolTip" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      <div class="modal-body"> <img class="stranger1_popup center-block img-responsive" src="emotional8_images/10aa.png"> </div>
    </div>
