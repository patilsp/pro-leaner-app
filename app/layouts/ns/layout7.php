<?php
  ...
  foreach($lp as $key => $value){
    $li = $value;
    if($li != ""){
        $text.='<li> <img id="_objective1" src="national7_images/value btn.png"  style="float:left">
...
<link rel="stylesheet" type="text/css" href="css/lessons/071vsns06.css">
<style></style>
</head>
<body>
<!-- Page container -->
      ...
      <div class="row mydivs">
        <div class="col-md-12  col-sm-12 col-xs-12 template img-responsive">
          ...
          <div class ="col-md-12 col-sm-12 col-xs-12 _content3">
           <img src="images/'.$_FILES['img']['name'][0].'" class="img-responsive"> </div>
        </div>
      </div>
    </div>
  </div>
