...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="css/lessons/061vsns10.css">
		<!-- Core JS files -->
					...
					<div class="row">
						<div class="col-md-12  col-sm-12 col-xs-12 template img-responsive"> 
							<div class="_content1">
                 			...
                 			<div class ="col-md-6 col-sm-6 col-xs-12 content_part _content2">
						        <img src="images/'.$_FILES['img']['name'][0].'"  class="img-responsive">
                 			</div>

							<div class ="col-md-6 col-sm-6 col-xs-12 _content2 _content">	 
