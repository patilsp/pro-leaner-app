<?php
  ...
  foreach($lp as $key => $value){
    $li = $value;
    if($li != ""){
        $text.='<li> <img id="_objective1" src="national9_images/value btn.png"  style="float:left">
...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="css/lessons/091vsns05a.css">
		<style type="text/css">
			                        ...
			                        <div class="col-md-12 col-sm-12 col-xs-12">
										...
										<div class="col-md-4 col-sm-4 col-xs-12">
											<center class="_content5">
												<img src="images/'.$_FILES['img']['name'][0].'" class="img-responsive img_center_2">
											</center>
										</div>
									</div>
    ...
    $("._content5").fadeOut("slow").delay(6000).fadeIn("slow");
