<?php
  ...
  foreach($lp as $key => $value){
    $li = $value;
    if($li != ""){
        $text.='<li> <img id="_objective1" src="natural6_images/vnatural btn.png"  style="float:left">
...
<link rel="stylesheet" type="text/css" href="css/lessons/062vsne05.css">
</head>
<body>
    ...
    <div class="content-wrapper">
      <div class="row">
        <div class="col-md-12  col-sm-12 col-xs-12 template img-responsive">
          ...
          <div class ="col-md-6 col-sm-12 col-xs-12 _content5">	<span class="ans1" style="color:red"><u style="z-index: 1; cursor:pointer;" data-toggle="modal" data-target="#myModal"> <img src="images/'.$_FILES['img']['name'][0].'" class="img-responsive"> </u></span> 
								    
						        </div>
          <div class="col-md-12 col-xs-12 col-sm-12 _content_part3">
            <center class="_content6">
		  ...
		  <div class="modal-dialog modal-sm" role="document">
			<div class="modal-content" style="background-color:#48c102;">
			  ...
			  <div class="modal-body">
				<img class="stranger1_popup center-block img-responsive" src='natural6_images/5a.png'>
			  </div>
