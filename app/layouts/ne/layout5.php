...
<link rel="stylesheet" type="text/css" href="css/lessons/062vsne12.css">
</head>
<body>
		  ...
		  <div class="modal-dialog modal-sm" role="document">
			<div class="modal-content" style="background-color:#48c102;">
			  ...
			  <div class="modal-body">
				<img class="stranger1_popup center-block img-responsive" src="natural6_images/10a.png">
			  </div>
