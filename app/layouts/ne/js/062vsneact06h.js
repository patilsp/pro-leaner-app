...
(function(window, document, undefined){
	var 	image = new Image(),
			...
			tiles = [],
			slots = [],
			SPRITE_SHEET = "url('images/bear.jpg')",
			mouseX,
			mouseY,
			offsetX,
			offsetY,
	...
	function mouseDown(e){
		...
		alert("Yipeeeee..! you have done all the levels and please close the window");
		document.location="savehighscore.php?seconds="+spent;
		} //else {
