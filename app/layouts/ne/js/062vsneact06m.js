...
(function(window, document, undefined){
	var 	image = new Image(),
			...
			tiles = [],
			slots = [],
			SPRITE_SHEET = "url('images/Rhino1.jpg')",
			mouseX,
			mouseY,
			offsetX,
			offsetY,
	...
	function mouseDown(e){
		...
		alert("Congratulations! You found all 15! You have spent "+spent+"seconds");
		alert("Click on OK for next level");
		document.location="062vsneact06h.php";
		} //else {
