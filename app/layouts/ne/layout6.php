<?php
  ...
  foreach($lp as $key => $value){
    $li = $value;
    if($li != ""){
        $text.='<li> <img id="_objective1" src="natural7_images/natural btn.png"  style="float:left">
...
<html>
	<head>
		...
		<title>CBSE PROGRAM-072vsne12</title>

		<link href="../assets/css/bootstrap.css" rel="stylesheet" type="text/css">
		<link rel="stylesheet" type="text/css" href="css/lessons/072vsne12.css">
		<!-- Core JS files -->
			...
			<div class="page-content">
				...
				<div class="content-wrapper">
					<div class="row">
						<div class="col-md-12  col-sm-12 col-xs-12 template img-responsive"> 
							<div class="_content1" >
                             ...
                             <!-- <div id="_try" class="pull-right"></div> -->
			                    ...
			                    <div class ="col-md-6 col-sm-6 col-xs-12 _content4">	 
                        ...
                        <div class="col-md-12  col-sm-12 col-xs-12 _content5 heigh">
		  ...
		  <div class="modal-dialog modal-sm" role="document">
			<div class="modal-content">
			  ...
			  <div class="modal-body">
				<img class="stranger1_popup center-block img-responsive" src="natural7_images/12a.png">
			  </div>
