<?php
  ...
  foreach($lp as $key => $value){
    $li = $value;
    if($li != ""){
        $text.='<li> <img id="_objective1" src="safe6_images/natural btn.png"  style="float:left">
...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/lessons/062vsspp03.css">
    </head>
    <body>
        ...
        <!-- Modal -->
        <div class="modal fade  bs-example-modal-sm" id="showToolTip" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
              <div class="modal-body">
                <img class="stranger1_popup center-block img-responsive" src="safe6_images/aa.png">
              </div>
            </div>
