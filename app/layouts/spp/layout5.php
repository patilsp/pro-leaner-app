<?php
  ...
  foreach($lp as $key => $value){
    $li = $value;
    if($li != ""){
        $text.='<li> <img id="_objective1" src="safe10_images/natural btn.png"  style="float:left">
...
<link rel="stylesheet" type="text/css" href="css/lessons/102vsspp06.css">
<!-- Core JS files -->
    ...
    <div class="content-wrapper">
      <div class="row mydivs">
        <div class="col-md-12  col-sm-12 col-xs-12 template img-responsive">
          ...
          <div class ="col-md-12 col-sm-12 col-xs-12 _content5"> <img src="images/'.$_FILES['img']['name'][0].'"   class="img-responsive"> </div>
        </div>
      </div>
    </div>
  </div>
