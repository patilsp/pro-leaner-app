...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="css/lessons/062vsie07.css">
	</head>
    <body>
						...
						<div class="col-md-12  col-sm-12 col-xs-12 template img-responsive"> 
							<div class="_content1" >
                             ...
                             <!-- <div id="_try" class="pull-right"></div> -->
							    <div class ="col-md-10 col-sm-10 col-xs-12 content_part">
				                    ...
				                    <div class="col-lg-6 col-md-6 col-sm-12">
                                    	<img class="sticky" src="images/'.$_FILES['img']['name'][0].'"class="img-responsive">
                                        <img class="sticky1" src="images/'.$_FILES['img']['name'][1].'" class="img-responsive">
                                    </div>	
...
<script>
	$(function(){
		$("._content1,._content2,._content3,._content4,._content5,._content6,._content7,._content8,._content9,.sticky,.sticky1").hide();
		...
		$(".sticky").fadeOut("slow").delay(6000).fadeIn("slow");
		$(".sticky1").fadeOut("slow").delay(6000).fadeIn("slow");
