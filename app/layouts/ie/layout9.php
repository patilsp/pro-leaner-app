<?php
  ...
  foreach($lp as $key => $value){
    $li = $value;
    if($li != ""){
        $text.='<li> <img id="_objective1" src="acadamic7_images/natural btn.png"  style="float:left">
...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="css/lessons/072vsieap10.css">
	</head>
    <body>
					...
					<div class="row">
						<div class="col-md-12  col-sm-12 col-xs-12 template img-responsive"> 
						    ...
						    <div class ="col-md-6 col-sm-6 col-xs-12 _content5">	 
								<img class="sticky1" src="images/'.$_FILES['img']['name'][0].'"  class="img-responsive">
								<img class="sticky2" src="images/'.$_FILES['img']['name'][1].'"  class="img-responsive">
						    </div> 
					</div>
				</div>
			</div>
