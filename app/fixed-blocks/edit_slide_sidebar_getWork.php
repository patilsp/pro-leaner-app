<div class="br-logo bg-br-primary bg-gardian-1"><a href="<?php echo $web_root; ?>app/taskList.php"><span>[</span><i class="menu-item-icon ion-ios-undo-outline tx-16">Return to Home</i><span>]</span></a></div>
<div class="br-sideleft overflow-y-auto">
  ...
  <div class="row">
    ...
    if (count($records) != 0) {
      ...
      {
        $slideid = $record['id'];
        $slide_name = "G".$class_id."_".$topic_code."_".$slideid."_S".$si++;
