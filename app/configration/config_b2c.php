...
$db_name="sp_2122_master"; // Database name

global $dbb2c;
try{
	$dbb2c = new PDO("mysql:host=$host;dbname=$db_name", $username, $password);
	// set the PDO error mode to exception
	$dbb2c->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION) ;
	$dbb2c->setAttribute(PDO::ATTR_EMULATE_PREPARES, true);
