...
<head>
  ...
  <body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <?php include("../../fixed-blocks/getWorkAdd_sidebar.php"); ?>
    <!-- ########## END: LEFT PANEL ########## -->
    ...
    <div class="br-mainpanel">
      ...
      <div class="br-pagebody">
        ...
        <div class="br-section-wrapper">
          <h6 class="br-section-label">Review New Slide</h6>
          <?php
            $all_files = array();
            $html_file = "";
            /*echo "<pre/>";
            print_r($getTaskStatus);*/
            foreach ($getTaskStatus['AssignedDepartments'] as $value) {
              $file_path_decode = json_decode($value['file_path']);
              //if($file_path_decode[0] != "") {
                //$file_path_decode1 = explode(",", $file_path_decode[0]);
                
              foreach($file_path_decode as $value) {
                $all_files[] = str_replace($dir_root, $web_root, $value);
                if(strpos($value,".html") > 0) {
                  $html_file = str_replace($dir_root, $web_root, $value);
                }
              }  
              //}
            }
          ?>
          <object width='100%' height='670px' data="<?php echo $html_file; ?>"></object>
        </div>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content tx-size-sm">
              <div class="modal-body tx-center pd-y-20 pd-x-20">
                ...
                <a href="<?php echo $web_root; ?>app/taskListAddSlides.php" class="btn btn-success tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium mg-b-20 close_save">
                  Close</a>
              </div><!-- modal-body -->
            </div><!-- modal-content -->
          </div><!-- modal-dialog -->
                ...
                <div class="col-md-12">
                  <div class="card bd-0">
                    ...
                    <div class="card-body bd bd-t-0 rounded-bottom">
                      ...
                      <input type="hidden" name="prev_slide_id" value="<?php echo $getTaskStatus['prev_slide_id']; ?>">
                      <input type="hidden" name="lesson_id" value="<?php echo $getTaskStatus['lesson_id']; ?>">
                      <?php foreach($all_files as $filepath) { ?>
                      <input type="hidden" name="file_path_html_css_imges[]" value="<?php echo $filepath; ?>">
                      <?php } ?>
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
