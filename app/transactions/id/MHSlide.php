...
<head>
  ...
  <body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <?php include("../../fixed-blocks/MHSlideSlidebar.php"); ?>
    <!-- ########## END: LEFT PANEL ########## -->
    ...
    <div class="br-mainpanel">
      ...
      <div class="br-pagebody">
        ...
        <div class="row">
          <div class="col-md-12 container_card">
            <div class="card" id="main_card">
              <div class="card-header main_header d-flex align-items-center justify-content-between pd-y-5">
                <h6 class="mg-b-0 tx-14 tx-inverse">Chapters</h6>
                <div class="card-option tx-24 d-flex justify-content-between">
                  <select class="form-control" name="diff_class" id="diff_class">
              ...
              <div class="card-body">
                <div class="row" id="container_slides">
      ...
      $(function(){
        ...
        $("#topic").change(function(){
          ...
          if(topic_id != ""){
            ...
            $.ajax({
              type: "POST",
              url: "../../apis/tasks/getMHLeftSlide.php",
