...
try{
  if($user_type == "Content Writer")
    $rolescreen = "Add Slides";
  else
    $rolescreen = "Review Slides";
  ...
  $get_task_assgin_gd = get_task_assgin_gd($_GET['task_assi_id']);
  //echo "data - ".$get_task_assgin_gd;
  
  //get topicName
  $sub_name = "";
  $get_sub_name = getCPSubject($_GET['class'], $_GET['subject']);
  if($get_sub_name != '') {
...
<head>
    ...
    <style type="text/css">
      ...
      */
      ...
      .clickSavedSlides, .sidebar-label{
        font-size: 11px;
      }
      .moveCursor {
        cursor: move;
      ...
      #delete_slide_modal.modal {
          z-index: 1052 !important;
      }
      #delete_slide_modal.modal-backdrop.show {
          z-index: 1051 !important;
      }

      #privewAllSlidesBody #accordion .card {
        margin-bottom: 30px;
        border: 0;
      }

      #privewAllSlidesBody #accordion .card .card-header {
        border: 0;
      ...
      #privewAllSlidesBody #accordion .card .card-header .btn-link {
        color: #fff;
        display: block;
        text-align: left;
        background: #818182;
      ...
      #privewAllSlidesBody #accordion .card .card-header .btn-link:after {
        content: "\f107";
      ...
      #privewAllSlidesBody #accordion .card .card-header .btn-link.collapsed {
        background: #818182;
        color: #fff;
      }

      #privewAllSlidesBody #accordion .card .card-header .btn-link.collapsed:after {
        content: "\f106";
        font: normal normal normal 14px/1 FontAwesome;
      }

      #privewAllSlidesBody #accordion .card .collapsing {
        background: #818182;
        line-height: 30px;
      }

      #privewAllSlidesBody #accordion .card .collapse {
        border: 0;
      }

      #privewAllSlidesBody #accordion .card .collapse.show {
        background: #81818291;
        line-height: 30px;
        color: #fff;
      }
  ...
  <body>
    ...
    <?php include("optionblocks/notepad.php"); ?>
    <!-- Page Content  -->
    <div id="content">
      <!-- ########## START: LEFT PANEL ########## -->
      ...
      <div class="br-mainpanel">
        <div class="br-pagebody">
          <input type="hidden" name="class" value="" class="pagebody_class" id="pagebody_class" />
          <input type="hidden" name="subject" value="" class="pagebody_subject" id="pagebody_subject" />
          <input type="hidden" name="chapter" value="" class="pagebody_chapter" />
          <input type="hidden" name="topic_id" value="" class="pagebody_topic_id" />
          <input type="hidden" name="sub_topic_id" value="" class="pagebody_sub_topic_id" />
          ...
          <input type="hidden" name="choosedLayoutId" id="choosedLayoutId" value="" />
          <!-- start you own content here -->
          <div class="br-section-wrapper">
            <div class="br-section-label" style="text-transform: none;display: flex;align-items: center;justify-content: space-between;">
              ...
              <div class="btn-group d-none" id="audioOption">
                ...
                <div class="dropdown-menu">
                  ...
                  <a class="dropdown-item" href="#" id="removeAudio">Remove</a>
                </div>
              </div>
            </div>
            <!-- <div class="row" style="margin: 0px;">
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">Notepad</div>
                  <div class="card-body">
          ...
          <!-- privewAllSlides Modal -->
          <div class="modal fade" id="privewAllSlides" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
            <div class="modal-dialog modal-full" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLongTitle">Preview All Sides</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
    ...
    <div id="add_topic_level_modal_review" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2">
      <div class="modal-dialog modal-lg" role="document" style="right: 0;transition: opacity 0.3s linear, right 0.3s ease-out;position: fixed;margin: auto;width: 620px;height: 100%;transform: translate3d(0%, 0, 0);">
        <div class="modal-content tx-size-sm" style="height: 100%;overflow-y: auto;border-radius: 0;border: none;">
          <div class="modal-header pd-x-20" style="padding-left:20px;padding-right:20px;display:flex;align-items:center;justify-content:space-between;padding:15px;border-bottom:1px solid #e9ecef;">
            <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Instruction</h6>
            <button type="button" class="close closeReviewPublish" aria-label="Close" style="padding:0;background:transparent;border:0;-webkit-appearance:none;float:right;font-size:1.3125rem;font-weight:700;line-height:1;color:#000;text-shadow:0 1px 0 #fff;opacity:.5;">
              <span aria-hidden="true">×</span>
            </button>
          </div>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="card bd-0">
                    ...
                    <div class="card-body bd bd-t-0 rounded-bottom">
                      <input type="hidden" name="class_id" id="reviewPublishClassId" value="<?php echo $_GET['class']; ?>">
                      <input type="hidden" name="subject_id" id="reviewPublishSubjectId" value="<?php echo $_GET['subject']; ?>">
                      <input type="hidden" name="task_assi_id" id="reviewPublishTaskAssiId" value="<?php echo $task_assi_id; ?>">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <form method="POST" id="slideTitleModalForm" enctype="multipart/form-data">
            ...
            <input type="hidden" name="chapter_id" value="" class="chapter_id" />
            <input type="hidden" name="topic_id" value="" class="topic_id" />
            <input type="hidden" name="sub_topic_id" value="" class="sub_topic_id" />
    ...
    <!-- Upload Audio -->
    <div id="audioModal" class="modal fade" data-backdrop="static" data-keyboard="false" tabindex="-1">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content tx-size-sm">
          <div class="modal-header pd-x-20">
            <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Audio</h6>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body pd-20">
            <form id="audio_upload">
              <input type="hidden" name="audiotopic_id" id="audiotopic_id" value="">
              <input type="hidden" name="audioclass_id" id="audioclass_id" value=""/>
              <input type="hidden" name="audioslide_id" id="audioslide_id" value=""/>
              <input type="hidden" name="audiosub_id" id="audiosub_id" value=""/>
              <input type="hidden" name="audiochapter" id="audiochapter" value=""/>
              <input type="hidden" name="audiosub_topic" id="audiosub_topic" value=""/>
              <div class="form-group">
                <label for="files">Attach Files:</label>
                <input type="file" class="form-control" name="audio_res[]" id="img_res" required="required"><br/>
              </div>
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content tx-size-sm">
          <div class="modal-header pd-x-20">
            ...
            <button type="button" class="close closeDeleteConfirmModal">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body pd-20">
            <div class="row">
              <div class="col-md-12">
                ...
                <input type="hidden" id="subject_id" value="<?php echo $_GET['subject']; ?>"/>
          ...
          <div class="modal-footer">
            ...
            <button class="btn btn-md btn-success closeDeleteConfirmModal">No</button>
          </div>
        </div>
      </div><!-- modal-dialog -->
    </div><!-- modal -->
          ...
          <div class="modal-body pd-20">
            <div class="row">
              <div class="col-md-12">
                ...
                <input type="hidden" id="move_subject_id" value="<?php echo $_GET['subject']; ?>"/>
    ...
    <script src="js/addSlide.js?ver=250120231647"></script>
  </body>
</html>
