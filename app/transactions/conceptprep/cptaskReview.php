...
try {
  ...
  $getTaskList = getCPTaskListReview($role_id, $logged_user_id);
                  ...
                  <div class="row"> 
                    ...
                    <table id="datatable" class="table table-striped table-bordered w-100">
                      ...
                      <tr>
                          ...
                          <td><span class="fw-semibold"><?php echo $task['className']; ?></span></td>
                          <td><span class="fw-semibold"><?php echo $task['subjectName']; ?></span></td>
                          <td><span class="fw-semibold"><?php echo $task['AssignedTo']; ?></span></td>
