    ...
    <div class="br-mainpanel">
      ...
      <div class="br-pagebody">
        ...
        <div class="br-section-wrapper">
          ...
          <object data="" id="obj" class="monkey-inline"></object>
      ...
      $(function(){
       ...
       /* $("#topic").change(function(){
        ...
        $(".templates").click(function(){
          ...
          var object = "<object data=\"<?php echo $web_root ?>app/"+templateid+"\" width=\"100%\" height=\"670\" class=\"monkey-inline\"></object>";
          //$("#div1").load("<?php echo $web_root ?>app/"+templateid);
          //$('#div1').html(object);
          $("#ifr").attr("src","<?php echo $web_root ?>app/"+templateid);
          //console.log($(frames["ifr"].window).contents().find("body"));
          console.log(document.getElementById('ifr').contentWindow.document.getElementById('_objective'));
