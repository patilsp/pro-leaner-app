...
try{
  ...
  //get topicName
  $top_name = "";
  $get_topic_name = getTopics($_GET['class']);
...
<head>
  ...
  <body>
      ...
      <div class="br-mainpanel">
        <div class="br-pagebody">
          ...
          <div class="br-section-wrapper">
            <h6 class="br-section-label"><?php echo $top_name; ?><b id="boxTitle"><?php echo " - ".$rolescreen; ?></b></h6>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <form method="POST" id="slideTitleModalForm" enctype="multipart/form-data">
            ...
            <input type="hidden" name="prev_slide_id" value="" class="prev_slide_id" />
            <!-- Modal body -->
            <div class="modal-body">
              <div class="row">
                <div class="col-md-12">
    ...
    <script src="js/addSlideExistingTopic.js"></script>
  </body>
</html>
