	...
	$("#dvSource img").draggable({
        ...
        stop: function (event, ui) {
	        ...
	        if (categories == category_type)
         	...
         	if ($('#dvDest1').children('img').length == 1 && $('#dvDest2').children('img').length == 1 && $('#dvDest3').children('img').length == 1 && $('#dvDest4').children('img').length == 1 && $('#dvDest5').children('img').length == 1 && $('#dvDest6').children('img').length == 1){
                  ...
                  if(i == 'qust1') {
                    ...
                    $("#card_row1").append(`<li>
                      <div class="card-header">
                        <label class="mb-0">`+option1+`</label>
                      </div>
                      <div class="inner_div" id="dvDest1" value='`+option1+`'>
                        
                      </div>
                    </li>`);
                    $("#corect_card_row1").append(`<li>
                      <div class="card-header">
                        <label class="mb-0">`+option1+`</label>
                      </div>
                      <div class="inner_div highlighter_focus_dropped" id="dvDest1"><img class="d-block mx-auto dropped" value="phy_group" src="`+question+`" alt="dragable_image"></div>
                    </li>`);                     
                  } else if(i == 'qust2') {
                    $.each(e, function(key, val){
                        if(key == "qust"){
                    ...
                    $("#card_row1").append(`<li>
                      ...
                      <div class="inner_div" id="dvDest2" value='`+option1+`'>
                    ...
                    $("#card_row1").append(`<li>
                      ...
                      <div class="inner_div" id="dvDest3" value='`+option1+`'>
                    ...
                    $("#card_row2").append(`<li>
                      ...
                      <div class="inner_div" id="dvDest4" value='`+option1+`'>
                        
                      </div>
                    </li>`);
                    $("#corect_card_row2").append(`<li>
                      <div class="card-header">
                        <label class="mb-0">`+option1+`</label>
                      </div>
                      <div class="inner_div highlighter_focus_dropped" id="dvDest1"><img class="d-block mx-auto dropped" value="phy_group" src="`+question+`" alt="dragable_image"></div>
                    ...
                    $("#card_row2").append(`<li>
                      ...
                      <div class="inner_div" id="dvDest5" value='`+option1+`'>
                    ...
                    $("#card_row2").append(`<li>
                      ...
                      <div class="inner_div" id="dvDest6" value='`+option1+`'>
