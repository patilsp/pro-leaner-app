    ...
    setTimeout(function () {
        ...
        $.ajax({
            ...
            success:function(data)
            {
              ...
              console.log(data.explanation.exp1," - ",data.explanation.exp2," - ",data.explanation.exp3)
              ...
              $("#word_list_row1").append(`<li class="btn_li" id="li1">`+data.word1+`</li>`);
							$("#word_list_row1").append(`<li class="btn_li" id="li2">`+data.word2+`</li>`);
							$("#word_list_row1").append(`<li class="btn_li" id="li3">`+data.word3+`</li>`);
							$("#word_list_row1").append(`<li class="btn_li" id="li4">`+data.word4+`</li>`);
                  ...
                  if(i == 'qust1') {
                    $.each(e, function(key, val){
                    	if(key == "qust_part1"){
                    		...
                    		$("#word_list_row2").append(`<li class="btn_li" id="li5">`+val+`</li>`);
                    		rightwords.push(val);
                    ...
                    $.each(e, function(key, val){
                    	if(key == "qust_part1"){
                    		...
                    		$("#word_list_row2").append(`<li class="btn_li" id="li6">`+val+`</li>`);
                    		rightwords.push(val);
                    	} else if(key == "qust_part2"){
                    		$("#qus2_loop").append(`<div class="input-group-prepend">
		                      <span class="input-group-text">`+val+`</span>
                    ...
                    $.each(e, function(key, val){
                    	if(key == "qust_part1"){
                    		...
                    		$("#word_list_row2").append(`<li class="btn_li" id="li7">`+val+`</li>`);
                    		rightwords.push(val);
                    	} else if(key == "qust_part2"){
                    		$("#qus3_loop").append(`<div class="input-group-prepend">
		                      <span class="input-group-text">`+val+`</span>
