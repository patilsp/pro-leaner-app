<?php
  ...
  try{
    ...
    $img2 = str_replace($web_root."app/contents/", "", $_REQUEST['img2']);
    $img3 = str_replace($web_root."app/contents/", "", $_REQUEST['img3']);
    $img4 = str_replace($web_root."app/contents/", "", $_REQUEST['img4']);
    $img5 = str_replace($web_root."app/contents/", "", $_REQUEST['img5']);
