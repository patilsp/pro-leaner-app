...
try{
  ...
  //get topicName
  $top_name = "";
  $get_topic_name = getHiddenTopicsTopicsAllSo($_GET['class']);
  foreach ($get_topic_name as $key => $value) {
    if($value['id'] == $_GET['topic']) {
...
<head>
  ...
  <body>
        ...
        <div class="br-pagebody">
          ...
          <div class="br-section-wrapper">
            <div class="br-section-label" style="text-transform: none;display: flex;align-items: center;justify-content: space-between;">
              <h6 style="margin-bottom: 0px"><?php echo "Class ".$_GET['class']; ?> - <?php echo $top_name; ?><b id="boxTitle"><?php echo " - ".$rolescreen; ?></b>&nbsp; &nbsp;<span id="clicked_slidepath"></span></h6>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="card bd-0">
                    ...
                    <div class="card-body bd bd-t-0 rounded-bottom">
                      <input type="hidden" name="class_id" id="reviewPublishClassId" value="<?php echo $class_id; ?>">
                      <input type="hidden" name="topic_id" id="reviewPublishTopicId" value="<?php echo $topic_id; ?>">
    ...
    <script src="js/addSlide.js?ver=210620211312"></script>
  </body>
</html>
